...
;@deffont setruby face="@ＭＳ Ｐ明朝" size=24 bold=false rubyface="@ＭＳ ゴシック" rubysize=12
@deffont setruby face="ＭＳ Ｐ明朝" size=24 bold=false rubyface="ＭＳ ゴシック" rubysize=12 Rbold=false
@resetfont
